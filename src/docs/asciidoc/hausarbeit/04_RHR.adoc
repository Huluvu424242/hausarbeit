...
Sind die Verpackunge der Ausgangsstoffe beschädigt, verschmutzt oder durchfeuchtet, so werden die Ausgangsstoffe gegebenenfalls von der Verwendung ausgeschlossen.
