...
- Art der Kledidung und die Häufigkeit des Wechselns der Kleidung richtet sich je nach den Reinheitsstufen der Produktionsräume
...
- Die Art des Kppf- und Mundschutzes, sowie dessen Wechsel richtet sich je nach Reinheitsgesetz des Produktionsraumes
...
In diesen Kontrollen werden bei den einzelnen Herstllungsschritten in geeigneter Weise Proben entnommen. Diese werden in Abhängigkeit von der Art des Produkts auf folgendes geprüft:

- Prüfung auf mikrobiologische Reinheit
- Prüfung auf Sterilität
- Prüfung auf pyrogene Verunreinigungen und Prüfung auf Abwesenheit von Salmonellen-Arten in Rohstoffen rierischer Herkunft
